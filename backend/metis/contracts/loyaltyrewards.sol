...
contract Rewards {
    ...
    event PointsTransferred(address indexed from, address indexed to, uint amount);
    ...
    modifier onlyUser() {
        require(isUserInArray(msg.sender), "Only registered users can perform this action");
        _;
    }
